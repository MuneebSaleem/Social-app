			...
			<div class="tab-pane active " id="tab">
				<div class="card-body p-0">
					<div class="header-user text-center mt-4 pb-4">
						...
						<div class="dropdown-item text-center font-weight-semibold user h3 mb-0">Tidda</div>
	...
	<div class="container">
		<div class="row align-items-center flex-row-reverse">
			<div class="col-lg-12 col-sm-12   text-center">
				Copyright © {{ now()->year }} <a href="#">Reisnapp</a>. Designed by <a href="https://www.muneebsaleem.com/">Muneeb Saleem</a> All rights reserved.
			</div>
		</div>
	</div>
</footer>
